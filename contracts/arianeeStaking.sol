 ...
 */
contract ArianeeStaking is ERC900 {
  ...
  // dolard cent for 1 aria unit
  uint256 public ariaUSDExchange;
  uint256 public minimalUSDStakable;
  ...
  event newStake(uint256 _amount, address staker);
  
    function updateAriaUSDExchange(uint256 _newAriaUSDExchange) public{
        ariaUSDExchange = _newAriaUSDExchange;
    }
    
    function updateMinimalUSDStakable(uint256 _newMinimalUSDStakable) public{
    ...
    function updateFeesReceiver(address _newFeesReceiver) public{
